...
const REQUIRED = [
  ...
  'quoted_amount','settled_amount','settlement_receipt_or_tx_reference',
...
function validatePaidEvidence(record) {
  ...
  if (typeof record.settlement_receipt_or_tx_reference !== 'string' || !record.settlement_receipt_or_tx_reference) errors.push('settlement_receipt_or_tx_reference');
